...
func TestGrokMediaGenerationEligibility(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "explicit paid JWT tier is eligible when billing quota fields are absent", account: &Account{Platform: PlatformGrok, Type: AccountTypeOAuth, Credentials: map[string]any{"subscription_tier": "supergrok_heavy"}, Extra: map[string]any{grokBillingExtraKey: &xai.BillingSummary{StatusCode: http.StatusOK, WeeklyStatusCode: http.StatusOK, MonthlyStatusCode: http.StatusOK}}}, want: true, wantReason: "credential_paid_tier"},
		{name: "free JWT tier remains rejected", account: &Account{Platform: PlatformGrok, Type: AccountTypeOAuth, Credentials: map[string]any{"subscription_tier": "free"}, Extra: map[string]any{grokBillingExtraKey: &xai.BillingSummary{StatusCode: http.StatusOK, WeeklyStatusCode: http.StatusOK, MonthlyStatusCode: http.StatusOK}}}, want: false, wantReason: "billing_free_tier"},
		{name: "unknown JWT tier remains inconclusive", account: &Account{Platform: PlatformGrok, Type: AccountTypeOAuth, Credentials: map[string]any{"subscription_tier": "unknown"}, Extra: map[string]any{grokBillingExtraKey: &xai.BillingSummary{StatusCode: http.StatusOK, WeeklyStatusCode: http.StatusOK, MonthlyStatusCode: http.StatusOK}}}, want: false, wantReason: "billing_inconclusive"},
