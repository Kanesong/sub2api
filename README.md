...
gateway:
  openai_ws:
    ...
    client_first_message_timeout_seconds: 180
...
The first-message timeout is a total read deadline. The 180-second default
accommodates large contexts and image-heavy requests over slower links; tune it
within 120-300 seconds for local network conditions. It expires before HTTP
bridge routing, so bridge mode does not override this limit.
